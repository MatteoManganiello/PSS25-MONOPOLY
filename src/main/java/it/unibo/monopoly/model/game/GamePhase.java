 ...
 * macchina a stati: il controller sa sempre "a che punto siamo" e la view puo'
 * abilitare o disabilitare i propri comandi di conseguenza (per esempio il
 * pulsante "Tira i dadi" e' attivo solo nella fase {@link #ROLL}).
 * <p>
